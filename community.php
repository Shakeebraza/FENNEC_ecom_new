    ...
    <div class="container mt-4 mb-5">
        <div class="row">
            <div class="col-12 d-flex justify-content-between mb-4">
                <div>
                    <h1 class="jobhead">2,366 ads Community</h1>
        ...
        <div class="row">
              ...
              <div class="container ">
                ...
                >
                    ...
                    <div class="product-card">
                      ...
                      <div class="card-body">
                        <div class="p-3">
                          ...
                          <p class="card-text">
                            Private | Date available: 15 Oct 2024 | House | 3 Beds  <br />Bradford, West Yorkshire</p>
                  ...
                  <div class="col">
                    <div class="product-card">
                      <img
                        src="https://imagedelivery.net/ePR8PyKf84wPHx7_RYmEag/2ed38474-e28c-4c10-7e5c-c35f46f70100/86"
                        class="card-img-top"
                        alt="Classic Maroon Kameez Shalwar"
                      />
                      <div class="discount-badge">-25%</div>
                      <div class="card-body">
                        <div class="p-3">
                            <h5 class="card-title">Air supreme suitcase (small)</h5>
                            <p class="card-text">
                  ...
                  <div class="col">
                    <div class="product-card">
                      <img
                        src="https://imagedelivery.net/ePR8PyKf84wPHx7_RYmEag/310ad08c-bb06-4305-134a-0069e7fa4300/86"
                        class="card-img-top"
                        alt="Classic Maroon Kameez Shalwar"
                      />
                      <div class="discount-badge">-25%</div>
                      <div class="card-body">
                        <div class="p-3">
                          <h5 class="card-title">Bills Inclusive Lovely Studio, Central London / Kilburn</h5>
                          <p class="card-text">
                            Romford, London <br />Self Employed | Recruitment Housekeep</p>
                            <p class="text-muted">Manchester</p>
                            <span class="product-price">£330</span>
            ...
            <div class="col-md-3 p-3 mb-5 sale-loc left-side">
              ...
              <div class="mb-4 p-3 sale-loc">
                  <h5>Category</h5>
                  <div class="ms-3">
                      <div class="custom-category">
                          <p>Events, Gigs & <br>Nightlife</p>
                      </div>
                      <div class="custom-category">
                          <p>Classes<span class="text-muted">(5637)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Sports Teams & <br>Partners <span class="text-muted">(4516)</span></p>
                      </div>
                      <div class="custom-category">
                          <p>Artists & Theatres <span class="text-muted">(4270)</span></p>
                      </div>
                  </div>
                  <div class="more-categories" id="moreCategories" style="display: none;">
                      <div class="ms-3 mt-2">
                          <div class="custom-category">
                              <p>Skills & Language Swap <span class="text-muted">(3147)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Lost & Found Stuff <span class="text-muted">(3070)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Skills & Language Swap <span class="text-muted">(3147)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Travel & Travel Partners <span class="text-muted">(3070)</span></p>
                          </div>
                          <div class="custom-category">
                              <p>Rideshare & Car Pooling<span class="text-muted">(2365)</span></p>
                          </div>
                      </div>
                  </div>
                  <a href="<?php echo $urlval?>" class="show pt-1" id="toggleCategories">Show 5 more</a>
              </div>
              <div class="more-categories" id="moreCategories" style="display: none;">
                  <div class="ms-3 mt-2">
                      <div class="custom-category">
