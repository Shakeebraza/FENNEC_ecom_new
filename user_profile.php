        ...
        <div class="d-flex align-items-left justify-content-between mb-4"
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                ?>
                    ...
                    <small class="text-muted" style="font-size: 0.9rem;">Posting for <?= $postingDuration ?>
                        years</small>
                </div>
            </div>
            ...
            <div class="tab-content mt-4" id="myTabContent">
                                ...
                                <div class="row g-0">
                                    <div class="col-4" style="background: #FFFFFF;">
                                        <div class="position-relative">
                                            ...
                                            <span
                                                class="position-absolute bottom-0 start-0 bg-dark text-white px-2 py-1 rounded-1"
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab"
                    ...
                    <div class="review-container mx-auto"
                        ...
                        <h2 style="font-size: 2rem; font-weight: bold; color: #00494f; text-align: center;">Client
                            Reviews</h2>
                        ...
                        <form action="" method="POST">
                            <div class="mb-3">
                                <label for="name" class="form-label" style="font-weight: 600; color: #333;">Your
                                    Name</label>
                            ...
                            <div class="mb-3">
                                <label for="review" class="form-label" style="font-weight: 600; color: #333;">Your
                                    Review</label>
                            ...
                            <div class="mb-3">
                                <label for="rating" class="form-label" style="font-weight: 600; color: #333;">Your
                                    Rating</label>
                            ...
                            <button type="submit" class="btn"
                                style="background-color: #00494f; color: white; border-radius: 5px; padding: 10px 20px; font-size: 1rem; transition: background-color 0.3s ease;">
                                Submit Review
                            </button>
                        </form>
...
if (empty($reviews)): ?>
                        ...
                        <div class="review-item"
                            style="margin-top: 30px; padding: 20px; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.05);">
