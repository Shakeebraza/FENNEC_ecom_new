...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        ...
        <link rel="stylesheet" type="text/css" href="<?= $urlval?>custom/js/slick/slick/slick.css">
        <link rel="stylesheet" type="text/css" href="<?= $urlval?>custom/js/slick/slick/slick-theme.css">
