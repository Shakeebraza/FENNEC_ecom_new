...
<script>
    ...
    // --- AUTO-REFRESH ADDED ---
    // We'll keep track of the current active conversation to poll for new messages every 5s.
    ...
    function startAutoRefresh(conversationId, productName, productImage, statusMessage) {
        ...
        // Load messages once right away
        loadMessages(conversationId, productName, productImage, statusMessage);

        // Set up repeated loading every 5 seconds
        autoRefreshInterval = setInterval(function() {
            // If you only want to refresh if the Messages tab is visible, check it here:
    ...
    // --- END AUTO-REFRESH ADD ---

    $(document).ready(function() {
        loadChatList();
        // You can comment out or keep this direct call if you like:
        ...
        $(document).on('click', '.chat-list-item', function() {
            ...
            // Instead of calling loadMessages directly, we call our new polling function:
    ...
    function sendMessage(conversationId, message) {
        // We'll handle sending a message in the code below
    }
