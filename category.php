                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min_price" class="form-control" id="minPrice"
                                        placeholder="<?= $lan['enter']?><?= $lan['minimum_Price']?>" min="0" step="500">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="max_price" class="form-control" id="maxPrice"
                                        placeholder="<?= $lan['enter']?><?= $lan['maximum_price']?>" min="0" step="500">
                                </div>
    ...
    <div class="row">
      ...
      ?>
        ...
        ?>
            ...
            <div
                style="background-color: <?php echo $banner['bg_color']; ?>; color: <?php echo $banner['text_color']; ?>; min-height: 50vh; position: relative;width: 15vw; display: flex; flex-direction: column; padding: 2rem;">
                <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: center;">
                    <h1 style="font-size: 2rem; margin-bottom: 0.5rem;"><?php echo $banner['title']; ?></h1>
                    <h2 style="font-size: 3rem; font-weight: 300;  color: <?php echo $banner['text_color']; ?>">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mobileres mb-4">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="view-option icon-list" data-cols="1" title="List view" onclick="setViewMode('list')">
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                    </div>
                    <div class="view-option icon-grid-2" data-cols="2" title="Two column grid"
                        onclick="setViewMode('grid-2')">
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                    </div>
                    <div class="view-option icon-grid-3 active" data-cols="3" title="Three column grid"
                ...
                <div class="dropdown custom-dropdown" style="max-width: 300px;">
                    <button class="btn btn-outline-primary dropdown-toggle w-100" type="button" id="sortDropdown"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                        ...
                        <li>
                            <button class="dropdown-item" onclick="setSort('pricelowtohigh')">Price: Low to
                                High</button>
                        </li>
                        <li>
                            <button class="dropdown-item" onclick="setSort('pricehightolow')">Price: High to
                                Low</button>
                        </li>
                        <li>
            ...
            <div class="container ">
                <div id="product-grid" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    <?php
                        ...
                        foreach ($products as $proval) {
                            ...
                            echo '
                                    ...
                                    if(isset($_SESSION['userid'])){
                                        ...
                                        echo'</div>
                                            <div class="card-body">
                                            <a href="' . $urlval .'p/'. urlencode($proval['slug']) . '/' . urlencode($name) . '/' . urlencode($description) . '">
                                                <div class="p-3">
