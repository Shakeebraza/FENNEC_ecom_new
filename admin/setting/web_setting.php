            ...
            <div class="container-fluid">
                <div class="card shadow-lg border-0">
                    <div class="card-header"
                        style="background: linear-gradient(45deg, #28a745, #218838); color: white;">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control border-secondary" id="usernameLength"
                                            name="usernameLength" <?= $disabled ?>
                                            placeholder="Minimum characters required"
                                            value="<?= htmlspecialchars($settings['username_length'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="passwordLength" class="form-label">Password Length</label>
                                        <input type="number" class="form-control border-secondary" id="passwordLength"
                                            name="passwordLength" <?= $disabled ?>
                                            placeholder="Minimum characters required"
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control border-secondary" id="imagesAllowed"
                                            name="imagesAllowed" <?= $disabled ?> placeholder="Maximum images allowed"
                                            value="<?= htmlspecialchars($settings['images_allowed'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="freeImages" class="form-label">Free Images</label>
                                        <input type="number" class="form-control border-secondary" id="freeImages"
                                            name="freeImages" <?= $disabled ?> placeholder="Free images allowed"
                                            value="<?= htmlspecialchars($settings['free_images'] ?? '') ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="imageSize" class="form-label">Image Size (Bytes)</label>
                                        <input type="number" class="form-control border-secondary" id="imageSize"
                            ...
                            <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control border-secondary" id="videosAllowed"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control border-secondary" id="siteCurrency"
                                            name="siteCurrency" <?= $disabled ?>>
                                            <option value="USD"
                                                <?= ($settings['site_currency'] ?? '') === 'USD' ? 'selected' : '' ?>>
                                                USD</option>
                                            <option value="AUD"
                                                <?= ($settings['site_currency'] ?? '') === 'AUD' ? 'selected' : '' ?>>
                                                AUD</option>
                                            <option value="CAD"
                                                <?= ($settings['site_currency'] ?? '') === 'CAD' ? 'selected' : '' ?>>
                                                CAD</option>
                                            <option value="JPY"
                                                <?= ($settings['site_currency'] ?? '') === 'JPY' ? 'selected' : '' ?>>
                                                JPY</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="duration" class="form-label">Duration</label>
                                        <input type="text" class="form-control border-secondary" id="duration"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control border-secondary" id="extensionDuration"
                                            name="extensionDuration" <?= $disabled ?>
