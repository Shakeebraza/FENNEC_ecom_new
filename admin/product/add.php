...
<div class="page-container">
    ...
    <div class="text-danger" id="countryError"></div> <!-- Error message -->
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="text-danger" id="aeraError"></div> 
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="text-danger" id="discountPriceError"></div> 
                                </div>
                            </div>

                            <button type="submit" class="btn btn-primary btnsubmit">Add New Ads</button>
                        </form>
