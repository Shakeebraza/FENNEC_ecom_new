...
<div class="row">
    <div class="col-lg-6">
        <div class="au-card recent-report">
            <div class="au-card-inner">
                <h3 class="title-2">Daily Logins</h3>
                <canvas id="daily-logins-chart"></canvas>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="au-card recent-report">
            <div class="au-card-inner">
                <h3 class="title-2">Sales Breakdown</h3>
                <canvas id="sales-breakdown-chart"></canvas>
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <div class="au-card recent-report">
            <div class="au-card-inner">
                <h3 class="title-2">Revenue Trends</h3>
    ...
    <div class="col-lg-6">
        <div class="au-card chart-percent-card">
            <div class="au-card-inner">
                <h3 class="title-2">User Activity Ratio</h3>
...
<script>// Daily Logins
new Chart(document.getElementById('daily-logins-chart'), {
    type: 'line',
    data: {
        labels: <?= $dailyLoginDatesJS ?>,
        datasets: [{
            label: 'Daily Logins',
            data: <?= $dailyLoginsJS ?>,
...
// Sales Breakdown
new Chart(document.getElementById('sales-breakdown-chart'), {
    type: 'bar',
    data: {
        labels: <?= $productTypesJS ?>,
        datasets: [{
            label: 'Sales',
            data: <?= $salesCountsJS ?>,
